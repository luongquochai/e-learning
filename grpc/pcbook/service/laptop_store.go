...
type InMemoryLaptopStore struct {
	mutex sync.RWMutex
	data  map[string]*pb.Laptop // key is LaptopID and value is Laptop object
}
...
// Search function searches fỏ laptops with filter, returns one by one via found function
